...
function getMelody() {
  ...
  if(javaGeburtsmonat < 7) {
    note.play(allFrequencies[javaGeburtstag*3)+1], now + 0);
    note.play(allFrequencies[javaGeburtstag*3)+4], now + 1);
    note.play(allFrequencies[javaGeburtstag*3)-2], now + 2);
    note.play(allFrequencies[javaGeburtstag*3)-5], now + 3);
    note.play(allFrequencies[javaGeburtstag*3)-2], now + 4);
    note.play(allFrequencies[javaGeburtstag*3)-2], now + 5);
    note.play(allFrequencies[javaGeburtstag*3)+4], now + 6);
